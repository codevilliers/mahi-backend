    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firebase_uid', models.CharField(blank=True, default=None, max_length=150, null=True)),
                ('sign_in_provider', models.CharField(default='django', max_length=20)),
                ...
                ('phone_number', models.CharField(blank=True, default=None, max_length=15, null=True, unique=True, verbose_name='phone number')),
                ('email_verified', models.BooleanField(default=False)),
                ('display_picture', models.ImageField(blank=True, max_length=255, null=True, upload_to='personal_files')),
